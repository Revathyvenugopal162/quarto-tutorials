...
smooth-scroll: true
abstract: |
    This is a tutorial on how to analyze the Palmer Penguins dataset using Python. We'll explore the relationship between body mass and flipper
---
...
![hgf](images/penguins.png){fig-alt="hf"}

This is *Tutorial sessions* and **bold testing**.
